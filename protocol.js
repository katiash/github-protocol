...
You do not need to add the remote upstream more than once. Once you have added it, you will have a connection to the master remote branch on your local machine. Just remember to run git pull upstream master before creating a new feature branch.
